...
*This is a fork of [nvim-lua/kickstart-modular.nvim](https://github.com/nvim-lua/kickstart-modular.nvim).*

This is my personal neovim configuration, based on the kickstart.nvim repository.
